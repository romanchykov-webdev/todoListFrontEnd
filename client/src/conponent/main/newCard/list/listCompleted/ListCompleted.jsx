...
import {dragAndDrop} from "../../../../../reducers/getSliceReducer"
import {removeCheckBox} from "../../../../../reducers/getSliceReducer"


const ListCompleted = ({item, itemTodo, dragStart, onDrop,isSectionFavorite=[],drop=[]}) => {
    ...
    function handlerRemoveItem(id) {
        ...
        if (Object.keys(itemTodo).length > 0) {
            ...
            console.log(id)
            console.log(itemTodo)
            dispatch(removeCheckBox({idCart:itemTodo.id,idItem:id}))
        }
    ...
    return (
        ...
        >
            <div className={s.wrapperItem}>
                ...
                style={drop===false ? {visibility:'hidden'} : {visibility:'visible'}}
                >
